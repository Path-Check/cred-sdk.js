...
test('Headers Badge', async () => {
  const mapOfHeadersAndFields = await header.parse("date/manuf/product/lot/boosts/passkey/route/site/dose/name/dob");
...
test('Headers Array', async () => {
  const mapOfHeadersAndFields = await header.parse(`nam.fn/nam.gn/nam.fnt/nam.gnt/dob/vax/test/recov
